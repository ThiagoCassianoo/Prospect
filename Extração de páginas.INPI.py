...
def extract_data_from_pdf(pdf_path):
    ...
    for match in matches:
        data.append({
            ...
            "Procurador": match[2].strip() if match[2] else "",
            "Detalhes do Despacho": match[3].strip(),
            "Possui Procurador": "Sim" if match[2] else "Não"
        })
    
    return data

# Caminho para o PDF
pdf_path = r"D:\Desktop\SC MARCAS\Arquivos\Marcas2819\Paginas_1763_a_1936.pdf"
...
if data:
    ...
    # Exportar para CSV
    output_csv_path = "Indeferidos_Completos_2.csv"  # Nome do arquivo CSV de saída
